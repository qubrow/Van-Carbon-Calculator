...
def main():
    ...
    st.info("    Solar power system (panels, batteries, inverter): 100–300 lbs")
    ...
    st.info("    Books, electronics, and entertainment gear: 10–50 lbs")
    st.info("    Food supplies: 20–60 lbs")
    st.info("    Outdoor gear such as climbing gear: 20-100+ lbs")
    st.info("    Insulation materials: 50–150 lbs")
