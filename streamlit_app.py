...
def main():
    ...
    st.markdown("-Water pump or filtration system: 5–10 lbs")
    st.write("Water and Plumbing")
    st.markdown("-Water tank (filled): 8.3 lbs per gallon (20-gallon tank = ~166 lbs")
    st.markdown("-Gray water tank: Similar weight, depending on size")
    st.markdown("-Plumbing materials (hoses, fittings): 10–20 lbs")
    st.write("Personal Items")
    st.markdown("-Clothing: 20–40 lbs")
    st.markdown("-Toiletries: 5–15 lbs")
    st.markdown("-Books, electronics, and entertainment gear: 10–50 lbs")
