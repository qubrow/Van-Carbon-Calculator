...
def main():
    ...
    added_weight = st.number_input("Enter Added Weight (in pounds)", min_value=0, step=10, help: "-Cabinets and storage units: 50–150 lbs/n-Table and seating: 40–100 lbs/n")
